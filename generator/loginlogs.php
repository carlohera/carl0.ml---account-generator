...
$result = mysqli_query($con, "SELECT * FROM `login_logs`") or die(mysqli_error($con));
while($row = mysqli_fetch_assoc($result)) {
    $result2 = mysqli_query($con, "SELECT * FROM `login_logs`") or die(mysqli_error($con));
    $totallogins = $totallogins + mysqli_num_rows($result2);
}
...
<?php include("noob/header.php"); ?>
         ...
         <div class="col-md-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  <center><h4 class="card-title">Login Ip Logs</h4></center>
                    ...
                    <div class="table-sorter-wrapper col-lg-12 table-responsive">
                               <table id="sortable-table-2" class="table table-striped">         
									  ...
									  <tr>
										  ...
										  <th><i class="fa fa-star"></i> IP  </th>
										  <th><i class="fa fa-star"></i> Date & Time </th>
									
									  </tr>
									  </thead>
									  <tbody class="searchable">
									      	<?php
								$supportquery = mysqli_query($con, "SELECT * FROM `login_logs` WHERE `username` = '$username' LIMIT 30");
